    ...
    <div className="min-h-screen w-full lg:grid-cols-[280px_1fr]">
        ...
        <main className="flex-1 flex flex-col">
          <div className="relative h-[200px] md:h-[300px] lg:h-[400px] overflow-hidden">
            <Image width={1000} height={200} alt="" className="object-cover object-center" src="/placeholder.svg" />
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8 lg:p-10">
              <div className="flex items-end gap-4">
                ...
                <div className="flex-1 text-white">
                  <h1 className="text-2xl font-bold md:text-3xl lg:text-4xl">{user?.fullName}</h1>
                  <p className="text-sm md:text-base lg:text-lg">{user?.id}</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <Card>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>The total number of visits to your profile.</CardDescription>
                </CardHeader>
                <CardContent>
