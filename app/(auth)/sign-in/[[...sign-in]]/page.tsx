...
const SignupForm = () => {
  ...
  return (
    <Form {...form}>
      ...
      <h2 className="h3 md:h2-bold pt-5 sm:pt-12">Login to your account</h2>
      <p className="text-gray-300 font-grotesk small-medium md:base-regular mt-12">To use Filterate Enter your Details</p>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="flex-col gap-5 w-full mt-4">
          ...
          <div className="flex flex-col items-start justify-center">
            <span className="mt-4">Dont have an account? <Link href='/sign-up' className="text-blue-300">Sign up</Link></span>
